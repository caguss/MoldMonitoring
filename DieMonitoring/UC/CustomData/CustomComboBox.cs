...
namespace DieMonitoring
{
    ...
    public partial class CustomComboBox : UserControl
    {
        ...
        private Color listBackColor = Color.FromArgb(27, 33, 38);
        ...
        List<string> cmbDatalist = new List<string>();
        ...
        //타이핑을 통한 콤보박스리스트 filtering 기능 구현하다가 말았음 
        ...
        //        {
        //            cmbDatalist.Add(cmbList.Items[i].ToString());
        //        }

        //    }
        //    else
        //    {
        //        cmbList.DroppedDown = false;//dropdown 닫고 다시 열어야할듯
        //        string filterString = cmbList.Text.ToString();

        //        var result = cmbDatalist.Where(x => x.Contains(filterString)).ToArray();

        //        cmbList.Items.AddRange(result);
